---
title: "Traffic volume prediction model - Report for Roads and Maritime Services, and other NSW Government stakeholders"
...
str(Holdout)
summary(Holdout)
Scenarios <- data.frame(Distance_CBD=c(10000,50000,25000,200000,100000),
                        road_functional_hierarchy=c("Primary Road","Motorway","Arterial Road","Local Road","Primary Road"),
                        rms_region=c("Sydney","Sydney","Sydney","Western","Hunter"),
                        day_of_week=c("MONDAY","FRIDAY","SUNDAY","TUESDAY","SATURDAY"),
                        public_holiday=c("FALSE","TRUE","FALSE","FALSE","TRUE"),
                        DailyRain=c(10,0,30,0,0),
                        school_holiday=c("FALSE","FALSE","TRUE","FALSE","TRUE"))
ScenarioPrediction <- exp(predict.glm(QP_Final,Scenarios))
ScenarioOutput <- cbind(Scenarios,ScenarioPrediction)

write.csv(ScenarioOutput,"scenarios.csv")
